...
/***/ function(module, exports, __webpack_require__) {
	...
	$('#new-symptom').on('submit', function (event) {
	  console.log("test");
	  event.preventDefault();
	  var title = $('#symptom-select option:selected').text();
	  var data = getFormFields(this);
	  console.log("submit");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newSymptom = function newSymptom(success, failure, title, data) {
	...
	//Update Symptoms
	var editSolution = function editSolution(success, failure, data, id) {
	  console.log(data, id);
	  $.ajax({
	    method: 'PATCH',
	...
	//DELETE Symptoms
	var deleteSymptom = function deleteSymptom(success, failure, id) {
	  $.ajax({
	    method: 'DELETE',
	    url: app.server.api + '/symptoms/' + id,
	    headers: {
	...
	var getSolutions = function getSolutions(success, failure, data) {
	  $.ajax({
	    method: "POST",
	...
	var newPass = function newPass(success, failure, data) {
	  $.ajax({
	    method: "POST",
	...
	var getPass = function getPass(success, failure) {
	  debugger;
	  $.ajax({
	    method: "GET",
	    url: app.server.api + '/passes/',
	...
	var editPass = function editPass(success, failure, data, id) {
	  console.log(data, id);
	  $.ajax({
	    method: 'PATCH',
	...
	var deletePass = function deletePass(success, failure) {
	  $.ajax({
	    method: "DELETE",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newSymptomSuccess = function newSymptomSuccess() {
	...
	var showSymptomsSuccess = function showSymptomsSuccess(data) {
	  console.log(data);
	};

	var editSolutionSuccess = function editSolutionSuccess() {
	  console.log("edited success");
	};

	var deleteSymptomSuccess = function deleteSymptomSuccess() {
	  console.log("deleted");
	};

	var getSolutionsSuccess = function getSolutionsSuccess(data) {
	  var solutionData = data.symptoms;
	  console.log(solutionData);
	  $('.show-solutions').html('');
	  display.displaySolutions(solutionData);
	};

	var showSymptoms = function showSymptoms(success, failure) {
	  $.ajax({
	    method: "GET",
	...
	var showCrud = function showCrud(passes) {
	  var passesListingTemplate = __webpack_require__(28);
	...
	var newPassSuccess = function newPassSuccess() {
	...
	module.exports = {
	  ...
	  showSymptomsSuccess: showSymptomsSuccess,
	  newSymptomSuccess: newSymptomSuccess,
	  getSolutionsSuccess: getSolutionsSuccess,
	  editSolutionSuccess: editSolutionSuccess,
	  deleteSymptomSuccess: deleteSymptomSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displaySolutions = function displaySolutions(solutions) {
	  ...
	  var solutionsListingTemplate = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<li>"
	    + alias2(alias1((depth0 != null ? depth0.solution : depth0), depth0))
	    + "\n<button type=\"button\"  class=\"btn btn-primary edit-solution-btn\" data-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" data-toggle=\"modal\" data-target=\"#edit-symptom-modal\">Update</button>\n<button type=\"button\"  id=\"delete-btn\" class=\"btn btn-primary\" data-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">Delete</button>\n</li>\n";
	  ...
	  return "<h2>Solutions</h2>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.solutions : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"show-crud\">\n  "
	    + alias2(alias1((depth0 != null ? depth0.crud : depth0), depth0))
	    + "\n  <td class=\"crud-title\">"
	    + alias2(alias1((depth0 != null ? depth0.title : depth0), depth0))
	    + "</td>\n  <td><button type=\"button\"  class=\"btn btn-primary edit-crud\" data-crud-id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\" data-target=\"#edit-crud-modal\">Update</button></td>\n  <td><button type=\"button\"  class=\"btn btn-danger delete-crud\" data-crud-id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\" data-target=\"#delete-crud-modal\">Delete</button></td>\n    </div>\n</tr>\n";
	  ...
	  return "<tr class=\"table-top-row\">\n  <td><b>CRUD</b></td>\n\n</tr>\n<tr class=\"table-top-row\">\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.passes : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.crud : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
